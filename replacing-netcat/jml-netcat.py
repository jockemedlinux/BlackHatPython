		...
		if self.args.execute:
			...
			while True:
				try:
					...
					print(f'Error: {e}')
					client_socket.send(b'An error occured, the server died.')
					client_socket.close()
					sys.exit()

if __name__ == '__main__':
	try:
		parser = argparse.ArgumentParser(description='Fake Net Cat', formatter_class=argparse.RawDescriptionHelpFormatter, epilog=textwrap.dedent
			('''
			...
			:Don't forget to CTRL-D when connecting to a server:
			'''))
